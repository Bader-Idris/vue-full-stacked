<template>
  <main class="home">
    <ArticleTicket
      color="white"
      classNameImage="articleTicket--image_createAndShare"
    ...
    >
      ...
      <template v-slot:paragraphe
        ...
        make it easy to share photos, tell stories and connect with
        others.</template
      >
    ...
    <ArticleTicket
      color="black"
      classNameImage="articleTicket--image_beautifulStories"
    ...
    >
      ...
      <template v-slot:paragraphe
        ...
        share your story with everyone.</template
      >
      <template v-slot:button>view the stories</template>
    </ArticleTicket>
    <ArticleTicket
      color="black"
      classNameImage="articleTicket--image_designedForEveryone"
      classNameArticleTicket="articleTicket--secondary"
    >
    ...
    <section class="home--breakpoints">
      <div class="home--breakpoints_contain">
        <Breakpoint
          nameBreakpoint="100% Responsive"
          text="No matter which the device you’re on, our site is fully responsive and stories look beautiful on any screen."
        >
          <template v-slot:iconBreakpoint
        ...
        <Breakpoint
          nameBreakpoint="No Photo Upload Limit"
        ...
        <Breakpoint
          nameBreakpoint="Available to Embed"
...
import Breakpoint from "@/components/home/Breakpoint.vue";
