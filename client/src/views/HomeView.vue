<template>
  <main class="home">
    <ArticleTicket
      color="white"
      class-name-image="articleTicket--image_createAndShare"
    ...
    <ArticleTicket
      color="black"
      class-name-image="articleTicket--image_beautifulStories"
      class-name-article-ticket="articleTicket--secondary"
    >
      <template #title>
    ...
    <ArticleTicket
      color="black"
      class-name-image="articleTicket--image_designedForEveryone"
      class-name-article-ticket="articleTicket--secondary"
    >
      <template #title>
    ...
    <section class="home--articles">
      <Article
        ...
        class-name="article--image_theMountains"
      />
      <Article
        date=""
        title="Sunset Cityscapes"
        author="Benjamin Cruz"
        class-name="article--image_sunsetCityscapes"
      />
      <Article
        date=""
        title="18 Days Voyage"
        author="Alexei Borodin"
        class-name="article--image_18DaysVoyage"
      />
      <Article
        date=""
        title="Architecturals"
        author="Samantha Brooke"
        class-name="article--image_architecturals"
      />
    </section>
    ...
    <section class="home--breakpoints">
      <div class="home--breakpoints_contain">
        <Breakpoint
          name-breakpoint="100% Responsive"
          text="No matter which the device you’re on, our site is fully responsive and stories look beautiful on any screen."
        >
          <template #iconBreakpoint>
            <svg
        ...
        <Breakpoint
          name-breakpoint="No Photo Upload Limit"
        ...
        <Breakpoint
          name-breakpoint="Available to Embed"
